...
2. Ejecuté el archivo con cat para ver qué contenía y apareció lo siguiente
...
3. Dentro del método `checkPassword`, el programa realiza una comparación directa utilizando el método `.equals()`. La cadena que está escrita de forma fija es la parte central de la bandera: `w4rm1ng_Up_w1tH_jAv4_000wYdiGTvt`
```
